...
namespace Bc
{
    public class Instructon_Set
    {
        public Instructon_Set()
        {
            ...
            instructions[0xC7] = () => setOneParam["RST"]("0"); // RST 0
            instructions[0xCF] = () => setOneParam["RST"]("1"); // RST 1
            instructions[0xD7] = () => setOneParam["RST"]("2"); // RST 2
            instructions[0xDF] = () => setOneParam["RST"]("3"); // RST 3
            instructions[0xE7] = () => setOneParam["RST"]("4"); // RST 4
            instructions[0xEF] = () => setOneParam["RST"]("5"); // RST 5
            instructions[0xF7] = () => setOneParam["RST"]("6"); // RST 6
            instructions[0xFF] = () => setOneParam["RST"]("7"); // RST 7
        ...
        private static bool isHalted = false;
        ...
        //-------------MEMORY-------------
        private static byte[] memory { get; } = new byte[0xFFFF];
        public byte[] Memory
        {
            get { return memory; }
        }

        private static int[] correspondingLinesToMemory { get; } = new int[0xFFFF];
        ...
        public List<string> TranslatedCode
        {
            get { return translatedCode; }
        }
        ...
        private static Dictionary<string, Action<string>> setOneParam { get; } = new Dictionary<string, Action<string>>
        {
            ...
            {"DAD", (RegPair) => {
                if(translatingCode)
                {
                    ...
                    {
                        //error msg: Registr neni B, D ani SP
                        Console.WriteLine( "Registr neni B, D ani SP");
                    }
                }
                else
                {
            ...
            {"JMP", (Label) => {
                ...
                if(translatingCode)
                {
                    if(labels.ContainsKey(Label))
                    {
                        ...
                        translatedCode.Add("C3 "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        ...
                        translatedCode.Add("C3 00 00");
                    }
                }
                else
                {
                    addressOfMemory = Get16bitValueFromMemory(specialRegisters["PC"] + 1);
            ...
            {"JC", (Label) => {
                ...
                if(translatingCode)
                {
                    if(labels.ContainsKey(Label))
                    {
                        ...
                        translatedCode.Add("DA "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"JNC", (Label) => {
                ...
                if(translatingCode)
                {
                    if(labels.ContainsKey(Label))
                    {
                        ...
                        translatedCode.Add("D2 "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"JM", (Label) => {
                ...
                if(translatingCode)
                {
                    if(labels.ContainsKey(Label))
                    {
                        ...
                        translatedCode.Add("FA "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"JP", (Label) => {
                ...
                if(translatingCode)
                {
                    if(labels.ContainsKey(Label))
                    {
                        ...
                        translatedCode.Add("F2 "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"JZ", (Label) => {
                ...
                if(translatingCode)
                {
                    if(labels.ContainsKey(Label))
                    {
                        ...
                        translatedCode.Add("CA "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"JNZ", (Label) => {
                ...
                if(translatingCode)
                {
                    if(labels.ContainsKey(Label))
                    {
                        ...
                        translatedCode.Add("C2 "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"JPE", (Label) => {
                ...
                if(translatingCode)
                {
                    if(labels.ContainsKey(Label))
                    {
                        ...
                        translatedCode.Add("EA "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"JPO", (Label) => {
                ...
                if(translatingCode)
                {
                    if(labels.ContainsKey(Label))
                    {
                        ...
                        translatedCode.Add("E2 "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"CALL", (Label) => {
                ...
                if(translatingCode)
                {
                    ...
                    {
                        addressOfMemory = labels[Label];
                        translatedCode.Add("CD "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"CC", (Label) => {
                ...
                if(translatingCode)
                {
                    ...
                    {
                        addressOfMemory = labels[Label];
                        translatedCode.Add("DC "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"CNC", (Label) => {
                ...
                if(translatingCode)
                {
                    ...
                    {
                        addressOfMemory = labels[Label];
                        translatedCode.Add("D4 "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"CP", (Label) => {
                ...
                if(translatingCode)
                {
                    ...
                    {
                        addressOfMemory = labels[Label];
                        translatedCode.Add("F4 "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"CM", (Label) => {
                ...
                if(translatingCode)
                {
                    ...
                    {
                        addressOfMemory = labels[Label];
                        translatedCode.Add("FC "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"CZ", (Label) => {
                ...
                if(translatingCode)
                {
                    ...
                    {
                        addressOfMemory = labels[Label];
                        translatedCode.Add("CC "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"CNZ", (Label) => {
                ...
                if(translatingCode)
                {
                    ...
                    {
                        addressOfMemory = labels[Label];
                        translatedCode.Add("C4 "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"CPE", (Label) => {
                ...
                if(translatingCode)
                {
                    ...
                    {
                        addressOfMemory = labels[Label];
                        translatedCode.Add("EC "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"CPO", (Label) => {
                ...
                if(translatingCode)
                {
                    ...
                    {
                        addressOfMemory = labels[Label];
                        translatedCode.Add("E4 "+Translate16BitNumber(addressOfMemory));
                    }
                    else
                    {
                        if(!instructionsWaitingForLabelAddress.ContainsKey(Label))
            ...
            {"RST", (Data) => {
                ...
                if(translatingCode)
                {
                    ...
                    {
                        // error: Wrong input. Must be 0-7.
                        throw new ArgumentException("Must be 0-7.");
                    }
                }
                else
                {
        ...
        private static Dictionary<string, Action<string, string>> setTwoParam { get; } = new Dictionary<string, Action<string, string>>
        {
            {"MOV", (RMd, RMs) => {
                ...
                if(translatingCode)
                {
                    ...
                    {
                        //error msg "RMd/RMs neni registr nebo pamet"
                        Console.WriteLine( "RMd/RMs neni registr nebo pamet");
                    }
                }
                else
                {
        ...
        // private static Action[] instructions { get; } = new Action[]
        // {
        //     instructions[0xCE] = () => setOneParam["ACI"](""),
        //     instructions[0xff] = () => setOneParam["ADD"]("A"),
        ...
        private static int ParseAndCheckNumber(string number, int numberOfBits)
        {
            ...
            if (r.IsMatch(number))
            {
                ...
                int DataVal;
                if (number.EndsWith("H") || number.EndsWith("CH"))
                {
        ...
        private static void CheckForLabel(string line, int lineCounter)
        {
            ...
            if (Regex.IsMatch(line, "^[A-Z]+[0-9]*:.*"))
            {
                ...
                if (label.Split(" ").Length > 1)
                {
                    ...
                    System.Console.WriteLine("invalid label name");
                }
                else
                {
                    if (labels.ContainsKey(label))
                    {
                        System.Console.WriteLine("Duplicate labels (" + label + ")");
                    }
                    else
                    {
        ...
        private static void loadParsedCodeToMemory()
        {
            ...
            // foreach (var koko in memory)
            // {
            //     System.Console.WriteLine(koko.ToString("X2"));
            // }
